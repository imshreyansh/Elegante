...
const getAllOrder = () => dispatch => {
  dispatch(Object(_loader__WEBPACK_IMPORTED_MODULE_4__["onLoader"])(true));
  axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(`${_config_config__WEBPACK_IMPORTED_MODULE_2__["IP"]}/api/order/getAllOrder`).then(res => {
    dispatch({
...
//# sourceMappingURL=main.e95eabb20d4b90a40ff9.hot-update.js.map